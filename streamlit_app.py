...
st.set_page_config(page_title="🔧 Auto-Tuned AI Crypto Alerts", layout="centered")
...
st.title("⚙️ Auto-Tuned AI Crypto Alerts")
...
forecast_minutes = st.slider("Forecast Time Ahead", 5, 1440, 30, step=5)
